...
### The final cost of an amortized loan is higher than you may think. Many loan recipients are not aware of how repayment of these loans work. Specifically how much of their payment is reducing the loan priciple for any given period.

#### This project will allow users to input loan information and see the breakdown of payments over time.

##### Vibe Coding may be a fun way to quickly build a project, but the goal here is to practice and learn.
